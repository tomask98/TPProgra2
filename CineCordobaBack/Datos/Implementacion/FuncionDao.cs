...
namespace CineCordobaBack.Datos.Implementacion
{
    public class FuncionDao : IFuncionDao
    {
        ...
        public List<TipoSalas> obtenerSalas(int idSucursal)
        {
            List<TipoSalas> lsalas = new List<TipoSalas>();
            List<Parametro> lparam = new List<Parametro>();
            Parametro parametro = new Parametro("@id_sucursal", idSucursal);
            lparam.Add(parametro);
            DataTable tabla = HelperDB.ObtenerInstancia().ConsultaTabla("sp_salas", lparam);
            ...
            foreach (DataRow fila in tabla.Rows)
            {
                ...
                TipoSalas ts = new TipoSalas(id_sala, tipo_sala);
                lsalas.Add(ts);
        ...
        public List<Sucursales> obtenerSucursales()
        {
            ...
            DataTable tabla = HelperDB.ObtenerInstancia().Consultar("sp_sucursales");
            foreach (DataRow fila in tabla.Rows)
            {
        ...
        {
            List<Horarios> lhorario = new List<Horarios>();
