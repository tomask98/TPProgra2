...
namespace CineCordobaBack.Datos.Implementacion
{
    public class ReporteDao:IReporteDao
    {
                                 ...
                                 string ts5, string ts6, string g1, string g2, string g3, string g4, string g5, string g6)
        {
            ...
            DataTable tabla = HelperDB.ObtenerInstancia().ConsultaTabla("SP_CONSULTA_CLARI", lParam);
            ...
            foreach (DataRow fila in tabla.Rows)
            {
                ...
                oDetalle.FuncionId.SalasId.TipoSala.Tipo = fila["Sala"].ToString();
                oDetalle.FuncionId.PeliculaId.Nombre_pelicula = fila["Pelicula"].ToString();
