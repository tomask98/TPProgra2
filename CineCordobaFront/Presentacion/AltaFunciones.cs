...
namespace CineCordobaFront.Presentacion
{
    public partial class AltaFunciones : Form
    {
        ...
        {
            string url = "https://localhost:7163/proxFuncion";
        ...
        {
            string url = "https://localhost:7163/traerSucursales";
        ...
        {
            string url = "https://localhost:7163/horarios";
            var DataJson = await ClienteSingleton.ObtenerInstancia().GetAsync(url);
            List<Horarios> lhorarios = JsonConvert.DeserializeObject<List<Horarios>>(DataJson);
        ...
        {
            string url = "https://localhost:7163/peliculas";
            var DataJson = await ClienteSingleton.ObtenerInstancia().GetAsync(url);
        ...
        private async void btnAceptar_Click(object sender, EventArgs e)
        {
            if (validar())
            {
                ...
                if (cboPelicula.SelectedItem is Peliculas peliculaSeleccionada)
                {
                ...
                if (cboSala.SelectedItem is TipoSalas tipoSalaSeleccionada)
                {
                ...
                Funcion.HorarioID = cboHorario.SelectedItem as Horarios;
        ...
        private async Task<bool> crearFuncionAsync(Funciones funcion)
        {
            string url = "https://localhost:7163/AltaFuncion";
        ...
        {
            string url = "https://localhost:7163/traerSalas" + "?id=" + idSucursal;
            var DataJson = await ClienteSingleton.ObtenerInstancia().GetAsync(url);
            List<TipoSalas> lsalas = JsonConvert.DeserializeObject<List<TipoSalas>>(DataJson);
