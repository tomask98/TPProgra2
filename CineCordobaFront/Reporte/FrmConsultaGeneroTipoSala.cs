...
namespace CordobaCineApp.Presentacion
{
    public partial class FrmConsultaGeneroTipoSala : Form
    {
        ...
        private async Task ConsultarComprobanteFiltrado(string fechaFormateada, string ts1, string ts2, string ts3, string ts4, string ts5, string ts6, string g1, string g2, string g3, string g4, string g5, string g6)
        {
            ...
            string url = "https://localhost:7163/comprobantesFiltrados?fechaDesde=" + fechaFormateada +
             "&ts1=" + ts1 +
             "&ts2=" + ts2 +
             "&ts3=" + ts3 +
             "&ts4=" + ts4 +
            ...
            {
                dataTable.Rows.Add(comp.Vendedor.Nombre, comp.Cliente.Nombre, comp.Detalle.FuncionId.SalasId.TipoSala.Tipo, comp.Detalle.FuncionId.PeliculaId.Nombre_pelicula, comp.Detalle.FuncionId.Fecha, comp.Detalle.FuncionId.PeliculaId.Genero.Genero);

                dgvConsultaClari.Rows.Add(new object[]
                {
                 comp.Vendedor.Nombre,
                 comp.Cliente.Nombre,
                 comp.Detalle.FuncionId.SalasId.TipoSala.Tipo,
                 comp.Detalle.FuncionId.PeliculaId.Nombre_pelicula,
